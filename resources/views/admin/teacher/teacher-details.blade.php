...
<div class="card-body">
  <a href="{{url('users/view')}}" class="btn btn-primary float-right btn-sm"><i class="fa fa-list"></i> Teacher Control</a>
    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
      ...
      <tbody>
        ...
        @foreach($users as $user)
          @if($user->publicationStatus == 1 && $user->usertype == "Teacher")
          <tr>
            <td>{{ $i++ }}</td>
